from mast.core.repositories.mirror import Mirror
...
packman_mirrors = [
    ...
    Mirror(url='ftp.fau.de/packman/', organization='University of Erlangen–Nuremberg (FAU)', location='Germany', sync_frequency='1h', protocols=['http', 'https', 'ftp']),
